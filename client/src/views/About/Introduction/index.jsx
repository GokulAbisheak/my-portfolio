    ...
    return (
        <>
            <div className='flex flex-col items-center min-h-screen bg-neutral-50 dark:bg-gray-900 pt-20'>
                ...
                <div style={{ maxWidth: '500px' }} className='mt-8 text-center text-neutral-950 dark:text-neutral-50'>
                ...
                <a href='#education'>
                    <button className='text-neutral-50 bg-gradient-to-r from-primary to-secondary mt-2 px-10 py-4 rounded uppercase mt-8'>
                        Know More About Me
                    </button>
                </a>
            </div>
