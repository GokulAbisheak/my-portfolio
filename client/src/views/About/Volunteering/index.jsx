    ...
    return (
        <>
            <div id='volunteering' className='flex flex-col items-center min-h-screen bg-neutral-50 dark:bg-gray-900 pt-20'>
                ...
                <div className='flex flex-col bg-neutral-50 dark:bg-gray-800 text-neutral-950 dark:text-neutral-50 border-2 border-b-0 border-primary dark:border-secondary new-shadow-xl mx-4'>
                    {VolunteeringData.map((list) => (
                        <div className='flex flex-row p-2 border-b-2 border-primary dark:border-secondary' style={{maxWidth: '500px'}}>
