        ...
        <>
            <div id='education' className='flex flex-col items-center min-h-screen bg-white dark:bg-gray-900 pt-20'>
                ...
                <div className='flex flex-col md:flex-row items-center text-center'>
                    <div className='flex flex-col items-center bg-neutral-50 dark:bg-gray-800 text-black dark:text-white p-5 mx-8 my-4 drop-shadow-lg' style={{ width: '300px', height: '500px' }}>
